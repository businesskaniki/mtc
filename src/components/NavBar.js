          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                <a href="https://wa.me/message/OPKFD5HACT6OK1"><img src={navIcon1} alt="" /></a>
                <a href="https://m.facebook.com/story.php?story_fbid=620365446254648&substory_index=620365446254648&id=100086412576076&sfnsn=mo&mibextid=RUbZ1f"><img src={navIcon2} alt="" /></a>
                <a href="https://www.instagram.com/microtaxconsultant?r=nametag"><img src={navIcon3} alt="" /></a>
              </div>
              <HashLink to='#connect'>
